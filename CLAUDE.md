...
- 展开态布局：黑幕从屏幕最顶垂下、盖住菜单栏带（与刘海连为一体，只圆下方两角）；顶栏经 padding-top = 菜单栏高 + 4 让位到拦截带下方；产品名为「TO-DO Panel」，顶部 Tab 避让物理刘海。
