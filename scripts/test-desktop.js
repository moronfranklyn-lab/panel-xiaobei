...
for (const file of ['main.js', 'main-services.js', 'platform.js', 'preload.js', 'renderer/domain.js', 'renderer/effects.js', 'renderer/app.js', 'renderer/workspace.js', 'renderer/icon-motion.js', 'renderer/notification.js', 'renderer/theme.js', 'renderer/theme-boot.js', 'renderer/pet-panel.js', 'renderer/pet-motion.js', 'renderer/pet.js', 'build/afterPack.js', 'scripts/capture-pet-walk.js', 'scripts/codex-notify.js', 'scripts/claude-notify.js', 'scripts/smoke-app.js']) {
